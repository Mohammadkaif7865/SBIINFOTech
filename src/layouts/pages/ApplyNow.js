    ...
    <div className="row">
      ...
      <div className="row">
         ...
         {/* <div className="d-flex justify-content-end">
            <Link className="removeMore"><i className="fa fa-trash-alt"></i> Remove</Link>
         </div> */}
      </div>
  </div></div>;
			        ...
			        <div className="col-lg-12">
    					<div className="innerBannerTitle venter">
                            ...
                            <div class="mt-4 text-center">
                                <Link to="tel:+91-9873477401 " class="btnThemeRed me-3"><i class="fa fa-phone"></i> +91-9873477401</Link>
                                <Link to="/apply-now" class="btnThemewhiteBorder"><i class="fa-solid fa-paper-plane"></i> Apply Now</Link>
                            </div>
    					</div>
        			</div>
                </div>
