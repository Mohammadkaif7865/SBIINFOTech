...
import WorkWebdesign from './component/WorkWebdesign';
import { Link } from "react-router-dom";
import BannerTextSlider from './component/BannerTextSlider';
import SliderTestimonials from './component/SliderTestimonials';
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import CountUp from 'react-countup';
import Faqs from './component/Faqs';
import DigitalMarketingTab from "./component/DigitalMarketingTab";
                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="videoLeft">
                            <h1 class="large_heading fontWeight800 text-white">TOP RATED</h1>
                            <h2 class="heading fontWeight700 my-2">WEB DESIGN AND <span>DIGITAL MARKETING AGENCY</span></h2>
                            <h3 class="sub_heading text-white">We Help you get</h3>
            ...
            <div className="col-lg-7 pe-lg-4">
              <div className="drivenLeft">
                ...
                <ul>
                  ...
                  <li><Link to="/search-engine-optimization-seo-services">Search Engine Optimization</Link></li>
                  <li><Link to="/social-media-marketing-services">Social Media Marketing</Link></li>
                  <li><Link to="/social-media-optimization-services">Social Media Optimization</Link></li>
                  <li><Link to="/influencer-marketing-services">Influencer Marketing</Link></li>
                </ul>
              </div>
            </div>
              <div className="col-lg-5">
          ...
          <div className="servicesWeb">
            <div className="inlineService">
              <div className="itemServiceLine" data-background="url(assets/images/bg/web-design.jpg)">
                ...
                <Link to="/website-designing-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine"  data-background="url(assets/images/bg/seo.jpg)">
                ...
                <Link to="/search-engine-optimization-seo-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine"  data-background="url(assets/images/bg/offshore.jpg)">
                ...
                <Link to="/search-engine-optimization-outsourcing-seo-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine borderTop"  data-background="url(assets/images/bg/web-development.jpg)">
                ...
                <Link to="/website-development-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine borderTop"  data-background="url(assets/images/bg/mobile-app.jpg)">
                ...
                <Link to="/mobile-application-development-services" className="linkService">Read More</Link>
              </div>
              <div className="itemServiceLine borderTop"  data-background="url(assets/images/bg/software-development.jpg)">
                ...
                <Link to="/software-development-services" className="linkService">Read More</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="contentTab">
        <div class="containerFull">
          <div class="row align-items-center">
            <div class="col-lg-9">
              <div class="titleLeft">
                <h5 class="heading fontWeight700"><span class="titleHighlight">Digital Marketing</span> Services</h5>
                <p class="mt-4">We understand that no two businesses can be the same and so is there website usage and therefore they will need a different CMS solution. We do Your business in your way.</p>
              </div>
            </div>
            <div class="col-lg-3 text-end">
              <div class="buttonRight">
                <Link to="/contact-us" class="btnThemeRed">Get a Quote</Link>
              </div>
            </div>
          </div>
          <hr/>
    ...
    <section class="bgGrey">
      <div class="containerFull">
        <div class="row">
          <div class="col-lg-8">
            <div class="row">
              <div class="col-lg-6 translate50">
                <Link to="#">
                  <div class="webDesignItem">
                    <div class="iconWe">
                        <img src="assets/images/icons/web-design.png" alt="Web Design"/>
                    </div>
                    <h4 class="small_heading fontWeight700">Website Designing</h4>
              ...
              <div class="col-lg-6">
                <Link to="#">
                  <div class="webDesignItem">
                    ...
                    <h4 class="small_heading fontWeight700">Custom Website Designing</h4>
              ...
              <div class="col-lg-6 translate50">
                <Link to="#">
                  <div class="webDesignItem">
                    ...
                    <h4 class="small_heading fontWeight700">Responsive Website Designing</h4>
              ...
              <div class="col-lg-6">
                <Link to="#">
                  <div class="webDesignItem">
                    ...
                    <h4 class="small_heading fontWeight700">E-commerce Website</h4>
          ...
          <div class="col-lg-4 ps-lg-4">
            <div class="rightServicesWeb">
              <picture>
                <source srcset="assets/images/programming-amico.webp" type="image/webp"/>
                <img src="assets/images/programming-amico.png" class="img-fluid" alt="Writng Programme"/>
              </picture>
              <h5 class="small_head text_red mt-4">We're offering</h5>
              <h4 class="regular_heading fontWeight700 mt-2">Website Design Services</h4>
              <p class="mt-3">We use latest technology and design innovations to develop creative, smart & user friendly websites to successfully connect users with brands. Empower yourself with the best website design company in India.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="bgAction">
      <div className="containerFull">
        <div className="d-flex align-items-center justify-content-between home_cta">
          ...
          <Link to="tel: +91-9222260000" className="btnAction">Let's Talk Growth <i className="bi bi-arrow-right"></i></Link>
        </div>
      </div>
    </section>
          ...
          <div className="row">
            <div className="col-lg-5">
              <div className="leftFAQ">
                ...
                <div>
                  <Link className="btnTheme mt-4" to="tel: +91-9222260000"><i className="fa fa-phone"></i>  +91-9222260000</Link>
                </div>
              </div>
            </div>
            <div className="col-lg-7">
              <div className="faqRight ps-lg-4">
                ...
                <div className="text-end">
                  <Link to="#" className="link mt-2">See All <i className="fa fa-caret-right"></i></Link>
                </div>
              </div>
            </div>
          </div>
