                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						...
    						<div className="mt-4">
    							<Link to="#requestQuote" className="btnThemeRed me-3"><i class="fa fa-phone"></i>  +91-9873477401</Link>
    							<Link to="#" className="btnThemewhiteBorder"><i className="fa-solid fa-paper-plane"></i>  Apply Now</Link>
    						</div>
    					</div>
        			</div>
                ...
                <div className="opening_wrap">
                    ...
                    <div className="opening_box">
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                <Link to="/apply-now" className="theme-btn small-btn success-btn">Apply Now</Link>
                            </div>
