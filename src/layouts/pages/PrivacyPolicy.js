    ...
    <div>
        ...
        <section id="sib-custom-page" className="privacyPolicy">
            ...
            <div className="custom-page-icon-box icon-with-title">
                ...
                <p>You can update or delete your personal data by sending and email with your request to <Link to="mailto:contact@sibinfotech.com">contact@sibinfotech.com</Link></p>
            </div>
            <div className="custom-page-icon-box icon-with-title">
                <h4 className="tite">
                    Cookies</h4>
            ...
            <div className="custom-page-icon-box icon-with-title">
                <p className="small_heading">
                Contact Details</p>
                <p><Link to="mailto:contact@sibinfotech.com">contact@sibinfotech.com</Link></p>
                <p><Link to="tel:+91-922222-60000">+91-922222-60000</Link></p>
            </div>
            </div>
        </section>
    </div>
