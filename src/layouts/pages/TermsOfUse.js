			        ...
			        <div className="col-lg-12">
    					<div className="innerBannerTitle venter">
                            ...
                            <div class="mt-5 text-center">
                                <Link to="https://www.sibinfotech.com/#requestQuote" class="btnThemeRed me-3"><i class="fa-solid fa-comment-dots"></i> Get a Quote</Link>
                                <Link to="contact.php" class="btnThemewhiteBorder"><i class="fa-solid fa-circle-question"></i> Ask a Question</Link>
                            </div>
    					</div>
        			</div>
                </div>
                ...
                <div className="row">
                    <div className="col-md-12">
                        ...
                        <div className="custom-page-icon-box icon-with-title">
                            ...
                            <p>
                                Clients wish to cancel any of our services will need to contact our billing department by sending an email to <Link to="mailto:billing@sibinfotech.com">billing@sibinfotech.com</Link></p>
                            <p>
                        ...
                        <div className="custom-page-icon-box icon-with-title">
                            ...
                            <div className="custom-page-icon-box icon-with-title">
                                ...
                                <p>
                                    If you have queries or suggestions regarding our refund policies kindly e–mail us at <Link to="mailto:billing@sibinfotech.com">billing@sibinfotech.com</Link></p>
                                <p>
