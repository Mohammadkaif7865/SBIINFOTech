                ...
                <div className={activeStep === "creative" ? "creative active" : "creative"}>
                    <div className="section-content">
                        ...
                        <div className="row mt-4">
                            <div className="col-lg-12">
                                <ul>
                                    <li class="customText">Finalize the target keywords</li>
                                    <li class="customText">Implementation of the finalized strategy</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className={activeStep === "production" ? "production active" : "production"}>
                    <div className="section-content">
                        ...
                        <div className="row mt-4">
                            <div className="col-lg-12">
                                <ul>
                                    <li class="customText">Weekly updates along with the campaign task performance list</li>
                                    <li class="customText">Dedicated account manager for 27*7*365 support</li>
                                    <li class="customText">Status reports and statistics of organic traffic, rank improvement, returning visitors and other progress measurement factors</li>
                                    <li class="customText">Monthly call for discussing current and future goals</li>
                                    <li class="customText">Regular updates via secure project management tools</li>
                                </ul>
                            </div>
                        </div>
                    </div>
