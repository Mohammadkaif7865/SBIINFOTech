                            ...
                            <div className="rightMain stickyRight">
                                {activeTab === 'section1' &&
                                    <div className="itemSidebar scroll" id="section1">
                                        ...
                                        <p class="mt-3">On-page SEO is the foundation of any successful SEO strategy. At SIB Infotech, we specialize in providing comprehensive <Link to="/on-page-seo-services">on-page SEO services</Link> that help businesses achieve higher search engine rankings, increased traffic, and improved user engagement.</p>
                                ...
                                {activeTab === 'section2' &&
                                    <div className="itemSidebar scroll" id="section2">
                                        ...
                                        <p class="mt-3">Off-page SEO is activities that are performed after the websites goes live. <Link to="/off-page-seo-services">Off-page SEO Service</Link> deals with the external links that direct traffic to your websites organically, also known as 'backlinks' This category deals with regulating the backlinks on other publisher's pages including blogs, which leads to building a reliable spot on the search engine and the rankings are set to the sky.</p>
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <ul className="listItems">
                                ...
                                {activeTab === 'section4' &&
                                    <div className="itemSidebar scroll" id="section4">
                                        ...
                                        <p class="mt-3"><Link to="/on-page-seo-services">Technical SEO</Link> focuses on the website's architecture and user interface that is the technical parameters that directly affect the visibility. It manages the technical set up of the website that is the code. Most search engines prioritize the website's code when ranking it for search engines.</p>
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <ul className="listItems">
                                ...
                                {activeTab === 'section5' &&
                                    <div className="itemSidebar scroll" id="section5">
                                        ...
                                        <p class="mt-3">Fuel your online store's success with our <Link to="/e-commerce-seo-services">E-Commerce SEO services</Link>. We optimize product visibility, streamline the shopping experience, and boost your sales. Elevate your digital presence and make your products stand out in the competitive online marketplace with our tailored solutions. Your success is our focus in the world of e-commerce.</p>
                                        <div className="row">
                                            <div className="col-lg-6">
                                                <ul className="listItems">
                                ...
                                {activeTab === 'section6' &&
                                    <div className="itemSidebar scroll" id="section6">
                                        ...
                                        <p class="mt-3">Mobile SEO is based on its name, which is meant for mobile devices. At present more than 60% of Google searches are done on mobile phones. This <Link to="/mobile-seo-services">Mobile SEO service</Link> optimizes your website on phones and makes it mobile-friendly</p>
                                        <div className="row">
                                            <div className="col-lg-7">
                                                <ul className="listItems">
