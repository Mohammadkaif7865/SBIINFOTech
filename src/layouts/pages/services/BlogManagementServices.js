                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						...
    						<div className="mt-4">
    							<Link to="#" className="btnThemeRed me-3"><i class="fa-solid fa-comment-dots"></i> Get a Quote</Link>
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <p className="customText">
                            Blogs are a very important part of any brand's website. Your brand forms an image that is created by your blog and its content. A proper blog can work wonders for your website. It is a great platform to interact with the audience and customers.</p>
                        <p className="customText">
                            Blog management plays a very crucial role in redefining and maintaining your company's website. It a procedure of content creation, maintenance and sharing of blogs to increase engagement and traffic of your website. Blog management is considered to be the most effective social media marketing tool to keep your blogs updated and fresh.</p>
                        <p className="customText">
                            An effective social media marketing strategy is a mixture of several tools including blog management that can set your sales on fire in no time. But the success is highly dependent on the blog management agency you choose for your brand's website. SIB Infotech can be your friend in need as it the best blog marketing management company in India with offices in Mumbai and Delhi offering top blog management services in India.</p>
                    </div>
                    <div className="col-lg-6">
                        <img className="image-full imgAnimation" src="assets/images/blog-managemnet-company-in-mumbai.svg" alt="blog-managemnet-company-in-mumbai" />
                    </div>
                </div>
            </div>
        </section>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-7">
                        <div className="middle-row">
                            ...
                            <div className="middle-box">
                                <img src="assets/images/icons/blog-management-boots-user-engagenment.svg" alt="best-blog-management-Boosts-user engagement-company-in-india"/>
                                <h4>
                                    Boosts user engagement</h4>
                            </div>
                        </div>
                        <div className="middle-row">
                            <div className="middle-box">
                                <img src="assets/images/icons/blog-managemnet-build-brand-reputation.svg" alt="best-blog-management-company-in-mumbai"/>
                                <h4>
                                    Builds brand reputation</h4>
                            </div>
                            <div className="middle-box">
                                <img src="assets/images/icons/blog-managemnet-increase-conversion.svg" alt="best-blog-management-companies"/>
                                <h4>
                                    Increases website conversions</h4>
                            </div>
                            <div className="middle-box">
                                <img src="assets/images/icons/blog-management-cost-effective.svg" alt="best-blog-management-companies-in-india"/>
                                <h4>
                                    Cost Effective</h4>
                            </div>
                        </div>
        ...
        <section className="bgGrey">
            <div className="containerFull">
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-4">
                        <div className="blog-box">
                            <img src="assets/images/icons/blog-managemnet-content-writting.svg" alt="blog-managemnet-content-writting"/>
                            <h4>
                                Proficient content writing</h4>
                            <p className="customText">
                                Our team of skilled and experienced content writers and bloggers create engaging, fresh and keyword integrated content for your blog. We provide content that can adapt to any style or tone which suits your industry. We create effective and optimized content that boosts your blog’s engagement.</p>
                        </div>
                    </div>
                    <div className="col-lg-4">
        ...
        <section className="blueBg2">
            <div className="containerFull">
                <div className="callAction">
                    ...
                    <Link to="/request-a-quote">Speak to Our Social Media Marketing Experts</Link></div>
