                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						<h3 className="heading fontWeight700 text-white">Web Usability Report</h3>
    						<div className="mt-4">
                    ...
                    <div className="col-lg-5 pe-lg-5 d-none d-lg-block">
                        <div className="bannerForm">
                            ...
                            <p>with <strong className="fontWeight600 text_red">Best <span className="textChange">Web Usability Report </span> Company in India</strong></p>
                            <BannerForm/>
                        </div>
                    </div>
                </div>
               ...
               <div className="row mt-4">
                  ...
                  <div className="col-md-6">
                     <div className="custom-page-img">
                        <img alt="Website Usability Report in India" className="img-fluid" src="assets/images/article-submission.png"/>
                     </div>
                  </div>
               </div>
               <div className="row">
