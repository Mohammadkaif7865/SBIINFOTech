                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						<h3 className="heading fontWeight700 text-white">Email Marketing Services</h3>
    						<div className="mt-4">
                    ...
                    <div className="col-lg-5 d-none d-lg-block pe-lg-5">
                        <div className="bannerForm">
                            ...
                            <p>with <strong className="fontWeight600 text_red">Best <span className="textChange">Email Marketing Services</span> Company in India</strong></p>
                            <BannerForm/>
                        </div>
                    </div>
                </div>
                ...
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <h3 className="customHeading customLineHeight">
                            SIB Infotech is the <span className="text_red">Email Marketing</span> Provider in India. We provide web-based mass mailing solutions with the database</h3>
                    ...
                    <div className="col-lg-6">
                        <div className="email-marketing-img-section">
                            <img className="image-full" src="assets/images/email-marketing-company-in-india.svg" alt="email-marketing-company-in-india"/>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>
                                            Price Per Email*</th>
                                        <td>
                                            <Link className="package-btn" to="/contact-us">ENQIRE</Link></td>
                                        <td>
                                            <Link className="package-btn" to="/contact-us">ENQIRE</Link></td>
                                        <td>
                                            <Link className="package-btn" to="/contact-us">ENQIRE</Link></td>
                                    ...
                                    <tr className="table-last-row">
                                        <td colspan="4">
                                            Email Template Designing charges extra, as applicable</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div className="col-lg-6">
                        <div className="bgBlueDarkRight bgBlueDarksmHeight">
                            <p className="customText text-white">
                                Sending newsletter to our customer is not often seen as a way for some businesses. Whereas other thinks it's irritating and other finds it an expensive way of marketing. But it is more effective because of only one single click of viewer can come up to your website. The practice of sending customer newsletters by email is seldom seen as a way forward for some businesses. While some individuals think it can be annoying, many businesses find it a cost effective marketing tool.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div className="containerFull">
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <p className="customText">
                            SIB Infotech also provides Email Database in India, offering you the email database as for each your need and if available with us. We also provide SMTP IP Solutions for you if you want Email Marketing through diverse range of Email Marketing Softwares. Our Email Marketing features include Online Stats, Report, Schedule Sending, Email Campaign Templates, and Contact List Management etc. our compact features also contain Autoresponder, ready for Survery, Custom Fields, Online Registration form etc.</p>
                    </div>
                    <div className="col-lg-6">
                        <div className="table-responsive">
                            <table className="table text-center table-bordered">
