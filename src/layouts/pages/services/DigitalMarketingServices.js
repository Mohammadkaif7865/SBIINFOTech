...
import Gads from '../../../assets/images/icons/g-ads.png'
import AmazonAds from '../../../assets/images/icons/amazon.png';
import LinkedinAds from '../../../assets/images/icons/linkedin-logo.png';
import InstagramAdd from './../../../assets/images/icons/instagram.png';
import googleAnalyticsPng from './../../../assets/images/google-analytics.png';
import googleAnalyticsWebp from './../../../assets/images/google-analytics.webp';
import googleAdsensePng from './../../../assets/images/google-adsense.png';
import googleAdsenseWebp from './../../../assets/images/google-adsense.webp';
import metaBusinessPng from './../../../assets/images/meta-business.png';
import metaBusinessWebp from './../../../assets/images/meta-business.webp';
import mailChimpPng from './../../../assets/images/mailchimp.png';
import mailChimpWebp from './../../../assets/images/mailchimp.webp';
import hubspotPng from './../../../assets/images/hubspot.png';
import hubspotWebp from './../../../assets/images/hubspot.webp';
import semrushPng from './../../../assets/images/semrush.png';
import semrushWebp from './../../../assets/images/semrush.webp';
import canvaPng from './../../../assets/images/canva.png';
import canvaWebp from './../../../assets/images/canva.webp';
import ahrefsPng from './../../../assets/images/ahrefs.png';
import ahrefsWebp from './../../../assets/images/ahrefs.webp';
import wordpressPng from './../../../assets/images/wordpress.png';
import wordpressWebp from './../../../assets/images/wordpress.webp';
import hootsuitePng from './../../../assets/images/hootsuite.png';
import hootsuiteWebp from './../../../assets/images/hootsuite.webp';
import zoomPng from './../../../assets/images/zoom.png';
import zoomWebp from './../../../assets/images/zoom.webp';
import shopifyPng from './../../../assets/images/shopify.png';
import shopifyWebp from './../../../assets/images/shopify.webp';
                 ...
                 <div className="row">
			        <div className="col-lg-7 ps-lg-5">
    					<div className="innerBannerTitle venter">
    						...
    						<div className="mt-4">
    							<Link to="/contact-us" className="btnThemeRed me-3"><i class="fa-solid fa-comment-dots"></i> Get a Quote</Link>
                ...
                <div className="mt-lg-4 row row-cols-2 row-cols-lg-5">
                    ...
                    <div className="col">
                        <div className="itemSpecialization">
                            <div className="iconSpecialization">
                                <picture>
                                    <img src={AmazonAds} alt="Amazon Ads"/>
                                </picture>
                            </div>
                    ...
                    <div className="col">
                        <div className="itemSpecialization">
                            <div className="iconSpecialization">
                                <picture>
                                    <img src={InstagramAdd} alt="Instagram Ads"/>
                                </picture>
                            </div>
                ...
                <div className="row mt-lg-3">
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={googleAnalyticsWebp} type="image/webp"/>
                    ...
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={googleAdsenseWebp} type="image/webp"/>
                                <img src={googleAdsensePng} alt="Google Adsense"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={metaBusinessWebp} type="image/webp"/>
                                <img src={metaBusinessPng} alt="Meta Bussiness"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={mailChimpWebp} type="image/webp"/>
                                <img src={mailChimpPng} alt="Mail Chimp"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={hubspotWebp} type="image/webp"/>
                                <img src={hubspotPng} alt="HubsSpot"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={semrushWebp} type="image/webp"/>
                                <img src={semrushPng} alt="Semrush"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={canvaWebp} type="image/webp"/>
                                <img src={canvaPng} alt="Canva"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={ahrefsWebp} type="image/webp"/>
                                <img src={ahrefsPng} alt="ahref"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={wordpressWebp} type="image/webp"/>
                                <img src={wordpressPng} alt="WordPress"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
                        <div className="toolsLogo">
                            <picture>
                                <source srcSet={hootsuiteWebp} type="image/webp"/>
                                <img src={hootsuitePng} alt="Hootsuite"/>
                            </picture>
                        </div>
                    </div>
                    <div className="col-lg-2 col-6 col-sm-3">
