          ...
          <div className="row">
            <div className="col-lg-7 ps-lg-5">
              <div className="innerBannerTitle venter">
                ...
                <div className="mt-4">
                  <Link to="https://www.sibinfotech.com/#requestQuote" className="btnThemeRed me-3"><i class="fa-solid fa-comment-dots"></i> Get a Quote</Link>
          ...
          <div className="row">
              ...
              <div className="col-lg-4">
                <div className="section-4-right text-center">
                    <Link className="customBtn" to="/contact-us" target="_blank">Contact Our Consultants</Link>
                </div>
              </div>
          </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
                <div class="section-4-right h-100">
                  <Link class="customBtn" to="/contact-us">Speak to our Experts</Link>
                </div>
            </div>
          </div>
        </div>
      ...
      <section class="bgGrey">
        <div class="containerFull">
          ...
          <div class="text-center">
            <Link class="btnPlans" to="https://www.sibinfotech.com/website-design-development-services-packages">View Plans</Link>
          </div>
        </div>
      </section>
